    ...
    <main>
        ...
        <article id="profile">
            ...
            <div class="artikel ber">
                <h1>VISI</h1>
                <p>Terciptanya sekolah yang unggul dalam prestasi, berkarakter, berakar pada budaya bangsa dan berwawasan lingkungan berlandaskan IMTAQ dan IPTEK</p>
                <br><br>
                <h1>MISI</h1>
                <p>Melaksanakan pembelajaran dan bimbingan secara efektif dan kompetitif
Mendorong dan membantu siswa untuk mengenali potensi dirinya sehingga dapat dikembangkan secara optimal
Menumbuhkan semangat keunggulan secara intensif kepada seluruh warga sekolah
Menumbuhkan dan melestarikan budaya lokal
Menumbuhkan penghayatan terhadap ajaran agama yang dianut sebagai landasan kearifan lokal dalam bergaul dan bertindak
